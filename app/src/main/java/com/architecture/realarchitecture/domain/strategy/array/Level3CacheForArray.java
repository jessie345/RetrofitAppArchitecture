 ...
 */
public class Level3CacheForArray extends ArrayGetStrategy {
    private MemoryStorage mMemoryDataPool;

    public Level3CacheForArray(String dataType, Call<Map<String, Object>> call, ResponseListener<List<Map<String, Object>>> callback) {
