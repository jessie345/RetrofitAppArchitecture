 ...
 */
public class ForceNetForArray extends ArrayGetStrategy {
    private MemoryStorage mMemoryDataPool;

    public ForceNetForArray(String dataType, Call<Map<String, Object>> call, ResponseListener<List<Map<String, Object>>> listener) {
        super(dataType, call, listener);
