...
public class Level3CacheForObject extends ObjectGetStrategy {
    ...
    public Level3CacheForObject(String dataType, String id, Call<Map<String, Object>> call, ResponseListener<Map<String, Object>> callback) {
        super(dataType, id, call, callback);
